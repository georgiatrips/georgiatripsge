...
(function () {
  ...
  */
  const PHRASES = {
    ...
    'Sign Out': { ka: 'გამოსვლა', ru: 'Выйти', tr: 'Çıkış', ar: 'تسجيل الخروج', he: 'הთנתקות', uk: 'Вийти' },
    'Admin Panel': { ka: 'ადმინ პანელი', ru: 'Панель администратора', tr: 'Yönetici Paneli', ar: 'لوحة التحكم', he: 'פאנל ניהול', uk: 'Панель адміністратора' },
