...
(function () {
  ...
  const STRINGS = {
    ...
    tag_one_day: {
      ka: 'ერთდღიანი თავგადასავალ���', en: 'One-Day Adventure', ru: 'Однодневное приключение',
    ...
    booking_success_alert: {
      ...
      uk: 'Дякуємо за бронювання туру «{tour}»!\n\nМи отримали ваш запит і підтвердимо його протягом 24 годин.\n\nПеревірте свою електронну пошту для деталей.'
    },
    ...
    empty_tours_category: {
      ...
      ar: 'لا توجد جولا�� في هذه الفئة حتى الآن.',
      he: 'עדיין אין סיורים בקטגוריה זו.',
      uk: 'У цій категорії ще немає турів.'
    },
    empty_saved: {
      ka: 'შენახული ტურები ��ერჯერობით არ გაქვთ.',
  ...
  */
  const PHRASES = {
    ...
    'Sign Up': { ka: 'რე���ისტრაცია', ru: 'Регистрация', tr: 'Kayıt Ol', ar: 'إنشاء حساب', he: 'הרשמה', uk: 'Реєстрація' },
    ...
    'Ancient culture, breathtaking mountains, world-class wine and legendary hospitality — all in one extraordinary destination.': {
      ka: 'უძველესი კულტურა, თვალწარმტაცი მთები, მსოფლიო დონის ღვინო ���ა ლეგენდარული სტუმართმოყვარეობა — ყველა ერთ განსაკუთრებულ მიმართულებაში.',
    ...
    'Discover Georgia with us! We offer both private and group tours tailored to your interests and schedule. Whether it\'s a one-day escape or a multi-day adventure, our professional guides promise an unforgettable journey.': {
      ...
      he: 'גלו את גאורגיה איתנו! אנו מציעים סיורים פרטיים וקבוצתיים המותאמים לתחומי העניין ולז��ן שלכם. בין אם מדובר בטיול של יום אחד או בהרפתקה של כמה ימים, המדריכים המקצועיים שלנו מבטיחים חוויה בלתי נשכחת.',
    ...
    'Tbilisi – Capital City': { ka: 'თბილისი – დედა��ალაქი', ru: 'Тб��лиси – Столица', tr: 'Tiflis – Başkent', ar: 'تبليسي – العاصمة', he: 'טביליסי – עיר הבירה', uk: 'Тбілісі – столиця' },
    ...
    'Svaneti – Ancient Highlands': { ka: 'სვანეთი – უძველესი მთიანეთი', ru: 'Сванетия – Древнее высокогорье', tr: 'Svaneti – Kadim Dağlık Bölge', ar: 'س��انيتي – المرتفعات القديمة', he: 'סוואנטי – רמות עתיקות', uk: 'Сванетія – давні високогір\'я' },
    ...
    'Terms': { ka: 'პირობები', ru: 'Условия', tr: 'Koşullar', ar: 'الشر��ط', he: 'תנאים', uk: 'Умови' },
    ...
    'Ready to book this tour? Fill out your details and our team will confirm your reservation within 24 hours.': {
      ...
      uk: 'Готові забронювати цей тур? Заповніть дані, і наша команда підтвердить бр��нювання протягом 24 годин.'
    },
    'Full Name': { ka: 'სახელი და გვარი', ru: 'Полное имя', tr: 'Ad Soyad', ar: 'الاسم الكامل', he: 'שם מלא', uk: 'Повне ім\'я' },
    'Your full name': { ka: 'თქვენი სახელი და გვარი', ru: 'Ваше полное имя', tr: 'Adınız ve soyadın��z', ar: 'اسمك الكامل', he: 'השם המלא שלך', uk: 'Ваше повне ім\'я' },
    ...
    'Number of People': { ka: 'ადამიან���ბის რაოდენობა', ru: 'Количество человек', tr: 'Kişi Sayısı', ar: 'عدد الأشخاص', he: 'מספר אנשים', uk: 'Кількість осіб' },
    ...
    'Get in Touch': { ka: 'დაგვიკავშირ��ით', ru: 'Связаться', tr: 'İletişime Geç', ar: 'تواصل معنا', he: 'צרו קשר', uk: 'Зв\'язатися' },
    ...
    'Full Name *': { ka: 'სახელი და გვარი *', ru: 'Полное имя *', tr: 'Ad Soyad *', ar: 'الاسم الكامل *', he: 'שם מלא *', uk: 'Повне ім\'я *' },
    'Email *': { ka: 'იმეილი *', ru: 'Эл. почта *', tr: 'E-posta *', ar: 'البريد الإلكتروني *', he: 'אימייל *', uk: 'Електронна по��та *' },
    ...
    'Find Your Perfect Tour': { ka: 'იპოვე შენთვის იდეა��ური ტური', ru: 'Найдите свой идеальный тур', tr: 'Size Uygun Turu Bulun', ar: 'ابحث عن جولتك المثالية', he: 'מצאו את הסיור המושלם עבורכם', uk: 'Знайдіть ідеальний тур для себе' },
    ...
    'Expert Local Guides': { ka: 'ადგილობრივი გამოცდილი გი��ები', ru: 'Местные опытные гиды', tr: 'Yerel Uzman Rehberler', ar: 'مرشدون محليون خبراء', he: 'מדריכים מקומיים מנוסים', uk: 'Місцеві досвідчені гіди' },
    ...
    'Modern, air-conditioned vehicles maintained to the highest safety standards for every route.': {
      ...
      ru: 'Современные автомобили с кондиционером, обслуживаемые по выс��им стандартам безопасности на каждом маршруте.',
    ...
    'Travel beyond Georgia and discover exciting places with our international tours.': {
      ka: 'იმოგზაურეთ საქართველოს გარეთ და აღმოაჩინეთ საინტერესო ადგილები ჩვე��ი საერთაშორისო ტურებით.',
      ...
      ar: 'سافر خارج جور��يا واكتشف أماكن مثيرة مع جولاتنا الدولية.',
    ...
    'Discover amazing destinations beyond Georgia with our international tour packages - from neighboring countries to worldwide adventures.': {
      ka: 'იმოგზაურეთ საქართველოს გარეთ და აღმოაჩინეთ საინტერესო ���დგილები ჩვენი საერთაშორისო ტურებით.',
      ru: 'Путешествуйте за пределы Грузии и открывайте интересные места с нашими международными турами.',
      tr: 'Gürcistan\'ın ötesine seyahat edin ve uluslararası turlarımızla heyecan verici yerleri keşfedin.',
      ar: 'سافر خارج جورجيا واكتشف أماكن مثيرة مع جولاتنا الدولية.',
      he: '��או לטייל מחוץ לגאורגיה וגלו מקומות מרגשים עם הסיורים הבינלאומיים שלנו.',
      uk: 'Подорожуйте за межі Грузії та відкривайте цікаві місця з нашими міжнародними турами.'
    },
    ...
    'Comfortable and safe vehicles for every journey across Georgia. Pick the car that fits your trip — an experienced driver is always included.': {
      ka: 'კომფორტული და უსაფრთხო ავტომობილები ყოველი მოგზაურობისთვის საქართველოში. აირჩიეთ თქვენს მგზავრობას მორგებული მანქანა — გამოცდილი მძღოლი ყოველთვის შედის ფასში.',
    ...
    'We meet you at the airport with a name sign, help with your luggage and take you straight to your hotel.': {
      ka: 'გხვდებით აეროპორტში სახელიანი ტაბლოთი, დაგეხმარებით ბარგში და პირდაპირ სასტუმროში მიგიყვანთ.',
    ...
    'Discover Tbilisi and Batumi with a friendly driver who knows every street and story of the city.': {
      ka: 'აღმოაჩინეთ თბილისი და ბათუმი მეგობრული მძღოლის თანხლებით, რომელმაც იცის ქალაქის ყოველი ქუჩა და ისტორია.',
    ...
    'Strong 4WD cars for Kazbegi, Svaneti, Tusheti and any off-road destination you want to visit.': {
      ka: 'მძლავრი 4WD ავტომობილები ყაზბეგში, სვანეთში, თუშეთში და ნებისმიერ ექსტრემალურ მიმართულებაზე.',
    ...
    'Spacious minivans with safety features — perfect for families, students and travel groups.': {
      ka: 'ფართო მიკროავტობუსები უსაფრთხოების ფუნქციებით — იდეალური ოჯახებისთვის, სტუდენტებისთვის და ჯგუფებისთვის.',
    ...
    'Professional driver who speaks English': { ka: 'პროფესიონალი მძღოლი, რომელიც ლაპარაკობს ინგლისურად', ru: 'Профессиональный водитель со знанием английского', tr: 'İngilizce bilen profesyonel şoför', ar: 'سائق محترف يتحدث الإنجليزية', he: 'נהג מקצועי שדובר אנגלית', uk: 'Професійний водій, який володіє англійською' },
    'Full insurance on every trip': { ka: 'სრული დაზღვევა ყოველი მგზავრობისას', ru: 'Полная страховка на каждую поездку', tr: 'Her yolculukta tam sigorta', ar: 'تأمين شامل في كل رحلة', he: 'ביטוח מלא בכל נסיעה', uk: 'Повне страхування в кожній поїздці' },
    ...
    'Bottled water for all passengers': { ka: 'ბოთლი წყალი ყველა მგზავრისთვის', ru: 'Бутилированная вода для всех пассажиров', tr: 'Tüm yolcular için şişe su', ar: 'مياه معبأة لجميع الركاب', he: 'מים בבקבוק לכל הנוסעים', uk: 'Бутильована вода для всіх пасажирів' },
    'Free hotel pickup and drop-off': { ka: 'უფასო ტრანსფერი სასტუმროდან და სასტუმრომდე', ru: 'Бесплатный трансфер из отеля и в отель', tr: 'Ücretsiz otel alışı ve bırakılışı', ar: 'خدمة توصيل واستقبال مجانية من الفندق', he: 'איסוף והחזרה חינם מהמלון', uk: 'Безкоштовний трансфер з готелю і до готелю' },
    'Clean, air-conditioned cabin': { ka: 'სუფთა, კონდიციონერიანი სალონი', ru: 'Чистый салон с кондиционером', tr: 'Temiz ve klimalı kabin', ar: 'مقصورة نظيفة ومكيّفة', he: 'תא נקי וממוזג', uk: 'Чистий салон з кондиціонером' },
    'Flexible route and timing': { ka: 'მოქნილი მარშრუტი და გრაფიკი', ru: 'Гибкий маршрут и график', tr: 'Esnek rota ve zamanlama', ar: 'مسار وتوقيت مرنان', he: 'מסלול ולוחות זמנים גמישים', uk: 'Гнучкий маршрут і графік' },
    '24/7 support during your trip': { ka: '24/7 მხარდაჭერა მოგზაურობის განმავლობაში', ru: 'Поддержка 24/7 во время поездки', tr: 'Yolculuğunuz boyunca 7/24 destek', ar: 'دعم على مدار الساعة طوال رحلتك', he: 'תמיכה 24/7 במהלך הנסיעה', uk: 'Підтримка 24/7 протягом поїздки' },
    ...
    'Local Expert': { ka: 'ადგილობრივი ექსპერტი', ru: 'Местный эксперт', tr: 'Yerel Uzman', ar: 'خبير محلي', he: 'מומחה מקומי', uk: 'Місцевий експерт' },
    'Your driver knows the roads and the best places to stop along the way.': {
      ka: 'თქვენი მძღოლი იცნობს გზებს და საუკეთესო გაჩერების ადგილებს.',
      ru: 'Ваш водитель знает дороги и лучшие места для остановок по пути.',
      tr: 'Şoförünüz yolları ve yol üzerindeki en güzel durak noktalarını bilir.',
      ar: 'يعرف سائقك الطرق وأفضل أماكن التوقف على الطريق.',
      he: 'הנהג שלכם מכיר את הדרכים ואת המקומות הטובים ביותר לעצור בהם בדרך.',
      uk: 'Ваш водій знає дороги та найкращі місця для зупинок у дорозі.'
    },
