  ...
  */
  const PHRASES = {
    ...
    'Discover new countries, taste different cuisines, and explore incredible places around the world. This program is perfect for those who love long adventures and want every day to be filled with something new.': {
      ...
      he: 'גלו ארצות חדשות, טעמו מטבחים שונים וחקרו מקומות מדהימים ברחבי העולם. התוכנית הזו מושלמת עבור אלו שאוהבים הרפתקאות ארו��ות ורוצים שכל יום יהיה מלא בחוויות חדשות.',
    ...
    'We offer comfortable vehicles for every need — whether it\'s getting around the city or a long journey into the mountains. Travel calmly and safely.': {
      ka: 'ჩვენთან დაგხვდებათ კომფორტული ავტომობილები ნებისმიერი საჭიროებისთვის — იქნება ეს ქალაქში გადაადგილება თუ გრძელი გზა მთაშ��. იმოგზაურეთ მშვიდად და უსაფრთხოდ.',
    ...
    'Your trusted travel partner in Georgia. Crafting genuine experiences since 2017.': {
      ...
      he: 'שותפכם המהימן לטיולים בגאורגיה. י��צרים חוויות אותנטיות מאז 2017.',
    ...
    'Filter by Category': { ka: 'გაფილტრე კატეგ��რიით', ru: 'Фильтровать по категории', tr: 'Kategoriye Göre Filtrele', ar: 'تصفية حسب الفئة', he: 'סינון לפי קטגוריה', uk: 'Фільтр за категорією' },
