  ...
  */
  const PHRASES = {
    ...
    'Discover new countries, taste different cuisines, and explore incredible places around the world. This program is perfect for those who love long adventures and want every day to be filled with something new.': {
      ka: 'აღმოაჩინე ახალი ქვეყნები, გასინჯე განსხვავებული კერძები და ნახე საოცარი ადგილები მთელ მსოფლიოში. ეს პროგრამა იდეალურია მათთვის, ვისაც უყვარს ხანგრძლივი თავგადასავლები და სურს, რომ ყოველი დღე სიახლით იყ��ს სავსე.',
    ...
    'View All International Tours': { ka: 'ყველა საერთაშორისო ტურის ნახვა', ru: 'Все международные туры', tr: 'Tüm Uluslararası Turlar', ar: 'عرض جميع الجولات الدولية', he: 'צפה בכל הסיורים הבינלאומיים', uk: 'Усі міжнародні ��ури' },
    ...
    'Leave a Review on Google Maps': { ka: 'დატოვე შეფასება Google Maps-ზე', ru: 'Остав��ть отзыв в Google Maps', tr: 'Google Haritalar\'da Yorum Bırak', ar: 'اترك تقييماً على خرائط جوجل', he: 'השאירו ביקורת ב-Google Maps', uk: 'Залишити відгук у Google Maps' },
    ...
    'Ready to book this tour? Fill out your details and our team will confirm your reservation within 24 hours.': {
      ka: 'მზად ხართ ტურის დასაჯავშნად? შეავსეთ დეტალები და ჩვენი გუნდი დაადასტურებს ჯავშანს 24 სა���თში.',
