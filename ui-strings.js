...
(function () {
  ...
  const STRINGS = {
    ...
    inc_water: {
      ka: 'წყალ�� და სნექები', en: 'Water and snacks', ru: 'Вода и закуски',
    ...
    empty_international: {
      ...
      uk: 'Міжн��родних турів поки немає. Зазирніть згодом!'
    },
    empty_cars: {
    ...
    empty_tours_category: {
      ...
      ar: 'لا توجد جولا�� ف�� هذه الفئة حتى الآن.',
  ...
  */
  const PHRASES = {
    ...
    'Cars': { ka: 'მანქანები', ru: 'Автомобили', tr: 'Araçlar', ar: 'السيارات', he: 'רכב��ם', uk: 'Авто' },
    ...
    'Real feedback from travelers who explored Georgia with us.': {
      ...
      ru: 'Настоящие отзывы путешественников, которые открыли Грузию вмес��е с нами.',
      ...
      uk: 'Справжні відгуки мандрівників, які відкрили Г��узію разом з нами.'
    },
    ...
    'Privacy Policy': { ka: 'კონფიდენციალურობის პოლიტიკა', ru: 'Политика конфиденциальн��сти', tr: 'Gizlilik Politikası', ar: 'سياسة الخصوصية', he: 'מדיניות פרטיות', uk: 'Політика конфіденційності' },
    ...
    'Discover amazing destinations beyond Georgia with our international tour packages - from neighboring countries to worldwide adventures.': {
      ...
      ru: 'Путешествуйте за пределы Грузии и открывайте интересные места с нашими меж��ународными турами.',
      tr: 'Gürcistan\'ın ötesine seyahat edin ve uluslararası turlarımızla heyecan verici yerleri keşfedin.',
    ...
    'Clean and comfortable cars with air-conditioning, checked before every trip.': {
      ka: '���უფთა და კომფორტული მანქანები კონდიციონერით, შემოწმებული ყოველი მგზავრობის წინ.',
      ...
      uk: 'Чисті й комфортні авто з кондиціонером, перевіряємо перед кожною поїз��кою.'
    },
