...
(function () {
  ...
  */
  ...
  'Batumi Tours': { ka: 'ბათუმის ტურები', en: 'Batumi Tours', ru: 'Туры в Батуми', tr: 'Batum Turları', ar: 'جولات باتومي', he: 'טיולים בבטומי', uk: 'Тури до Батумі' },
  'Black Sea Coast': { ka: 'შავი ზღვის სანაპირო', en: 'Black Sea Coast', ru: 'Побережье Чёрного моря', tr: 'Karadeniz Kıyısı', ar: 'ساحل البحر الأسود', he: 'חוף הים השחור', uk: 'Узбережжя Чорного моря' },
  'Sun, sea and unforgettable adventures on Georgia\'s coastline. Pick your favourite Batumi escape below.': { ka: 'მზე, ზღვა და დაუვიწყარი თავგადასავლები საქართველოს სანაპიროზე. აირჩიეთ თქვენი საუკეთესო ბათუმის შეთავაზება.', en: 'Sun, sea and unforgettable adventures on Georgia\'s coastline. Pick your favourite Batumi escape below.', ru: 'Солнце, море и незабываемые приключения на побережье Грузии. Выберите свой любимый тур в Батуми ниже.', tr: 'Gürcistan kıyısında güneş, deniz ve unutulmaz maceralar. Aşağıdan favori Batum kaçamağınızı seçin.', ar: 'الشمس والبحر ومغامرات لا تُنسى على ساحل جورجيا. اختر رحلتك المفضلة إلى باتومي أدناه.', he: 'שמש, ים והרפתקאות בלתי נשכחות לאורך חופי גאורגיה. בחר את חופשת בטומי האהובה עליך.', uk: 'Сонце, море та незабутні пригоди на узбережжі Грузії. Обери свою улюблену подорож до Батумі.' },
  'View All Batumi Tours': { ka: 'ნახე ბათუმის ყველა ტური', en: 'View All Batumi Tours', ru: 'Все туры в Батуми', tr: 'Tüm Batum Turlarını Gör', ar: 'عرض كل جولات باتومي', he: 'כל הטיולים לבטומי', uk: 'Усі тури до Батумі' },
  'No Batumi tours yet — check back soon.': { ka: 'ბათუმის ტურები ჯერ არ არის — მალე დაგვიბრუნდით.', en: 'No Batumi tours yet — check back soon.', ru: 'Туров в Батуми пока нет — загляните позже.', tr: 'Henüz Batum turu yok — yakında tekrar bakın.', ar: 'لا توجد جولات إلى باتومي بعد — تحقق قريبًا.', he: 'אין עדיין טיולים לבטומי — חזרו בקרוב.', uk: 'Турів до Батумі поки що немає — завітайте пізніше.' },
    ...
    'Your Activity': { ka: 'თქ���ენი აქტივობა', ru: 'Ваша активность', tr: 'Aktiviteniz', ar: 'نشاطك', he: 'הפעילות שלך', uk: 'Ваша активність' },
    ...
    'Sign Out': { ka: 'გამოსვლა', ru: 'Вы��ти', tr: 'Çıkış Yap', ar: 'تسجيل الخروج', he: 'התנתקות', uk: 'Вийти' },
    ...
    'You can request access, correction, or deletion of your personal data by contacting us.': {
      ka: 'შეგიძლიათ მოგვმართოთ და მოითხოვოთ თქვენს პ��რსონალურ მონაცემებზე წვდომა, შესწორება ან წაშლა.',
    ...
    'Practical travel advice and inspiring stories — updated regularly by our local team.': {
      ...
      he: 'עצות טיול מעשיות וסיפורים מעוררי השראה — מתעדכנים באופן קבוע על ידי הצוות המ��ומי שלנו.',
    ...
    'Travelers Hosted': { ka: 'მასპინძლობილი მოგზაურები', ru: 'При��ято путешественников', tr: 'Ağırlanan Gezginler', ar: 'المسافرون الذين استضفناهم', he: 'מטיילים שהתארחו אצלנו', uk: 'Мандрівників прийнято' },
    ...
    'From operations to guest support, we keep high standards and continuously improve every detail.': {
      ...
      ru: 'От операционных процессов до поддержки гостей — мы держим высокий стандарт и пост��янно улучшаем каждую деталь.',
    ...
    'On the trip, our team handles logistics and support so you can enjoy the journey.': {
      ka: 'მოგზაურობისას ჩვენი ��უნდი მართავს ლოჯისტიკასა და მხარდაჭერას, რათა თქვენ უბრალოდ ისიამოვნოთ გზით.',
    ...
    'Why Us': { ka: 'რატომ ჩვენ', ru: 'Почему мы', tr: 'Neden Biz', ar: 'لماذا نحن', he: 'למה אנחנו', uk: 'Чому ми' },
    'Why Book a Car With Us': { ka: 'რატომ ჯავშნოთ ��ანქანა ჩვენთან', ru: 'Почему стоит заказать авто у нас', tr: 'Neden Aracı Bizden Kiralamalısınız', ar: 'لماذا تحجز سيارة معنا', he: 'למה להזמין רכב דרכנו', uk: 'Чому варто замовити авто в нас' },
    ...
    'All vehicles are checked regularly and meet strict safety standards.': {
      ...
      ar: 'يتم فحص جميع المركبات بانتظام وتلتزم بمعايير الس��امة الصارمة.',
    ...
    'Discover the beauty of Georgia with our carefully curated domestic tours - from day trips to multi-day adventures.': {
      ka: 'აღმოაჩინეთ საქართველოს ს���ლამაზე ჩვენი საგულდაგულოდ შერჩეული შიდა ტურებით - ერთდღიანი მოგზაურობიდან მრავალდღიან თავგადასავლებამდე.',
