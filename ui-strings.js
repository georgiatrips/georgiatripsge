...
(function () {
  ...
  const STRINGS = {
    ...
    /* ---- Empty states ---- */
    empty_domestic: {
      ka: 'შიდა ტურები ჯერ არ არის. მალე შემოიარეთ!',
    ...
    empty_international: {
      ka: 'საერთაშორისო ტურები ჯერ არ არის. მალე შემოიარეთ!',
    ...
    empty_featured: {
      ka: 'რჩეული შეთავაზებები ჯერ არ არის.',
    ...
    empty_tours_category: {
      ka: 'ამ კატეგორიის ტურები ჯერ არ არის.',
    ...
    empty_saved: {
      ka: 'შენახული ტურები ჯერ არ გაქვთ.',
  ...
  */
  const PHRASES = {
    ...
    'With Us': { ka: 'ჩვენთა�� ერთად', ru: 'Вместе с нами', tr: 'Bizimle', ar: 'معنا', he: 'איתנו', fa: 'با ما', uk: 'Разом з нами' },
    ...
    'Loading featured offers...': { ka: 'იტვირთება რჩეული შეთავაზებები...', ru: 'Заг��ужаются рекомендуемые предложения...', tr: 'Öne çıkan teklifler yükleniyor...', ar: 'جاري تحميل العروض المميزة...', he: 'טוען מבצעים מובילים...', fa: 'در حال بارگذاری پیشنهادات ویژه...', uk: 'Завантаження рекомендацій...' },
    ...
    'Ready to book this tour? Fill out your details and our team will confirm your reservation within 24 hours.': {
      ka: 'მზად ხართ ტურის დასაჯავშნად? შეავსეთ დეტალები დ�� ჩვენი გუნდი დაადასტურებს ჯავშანს 24 საათში.',
    ...
    'Log Out': { ka: 'გ��სვლა', ru: 'Выйти', tr: 'Çıkış yap', ar: 'تسجيل الخروج', he: 'התנתק', fa: 'خروج', uk: 'Вийти' }
  };
